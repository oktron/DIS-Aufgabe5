...
public class RecoveryWerkzeug {
    ...
    public RecoveryWerkzeug() throws Exception{
        BufferedReader brOfNutz = new BufferedReader(
        		             new InputStreamReader(
        		              new FileInputStream("./bestand/nutzdaten.txt")));
        ...
        BufferedReader brOfLog = new BufferedReader(
        		             new InputStreamReader(
        		              new FileInputStream("./bestand/logdaten.txt")));
